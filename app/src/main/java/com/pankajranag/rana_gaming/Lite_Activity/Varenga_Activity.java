...
public class Varenga_Activity extends AppCompatActivity implements RewardedVideoAdListener {
    ...
    private DatabaseReference dbrefrence = databaseReference.child("pubglite").child("image2");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_varenga_);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(Varenga_Activity.this)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                TextView  pubg_id;
                                EditText pubg_name;
                                final Dialog dialog1 = new Dialog(Varenga_Activity.this);
...
//                        }, 2000L);
        ...
        info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(Varenga_Activity.this);
        ...
        mFirebaseRemoteConfig.fetch().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Varenga_Activity.this, "Something went wrong please try again",
...
//                    String payment_response = data.getStringExtra("payment_response");
    ...
    private void init() {
        ...
        Post = FirebaseDatabase.getInstance().getReference().child("varengalite");
    }
    ...
    protected void onStart() {
        ...
        dbrefrence.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(Varenga_Activity.this)
                        .load(firstimage)
                        .into(bigimage);

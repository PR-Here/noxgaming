...
public class LiteSquadLoadPlayer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lite_squad_load_player_);
        ...
        databaseReference = database.getReference("LiteSquad_join_player").child("EntryComplete_player");


        recyclerView = (RecyclerView) findViewById(R.id.recyclerview_load2);

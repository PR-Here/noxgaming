...
public class LiteSoloLoadPlayer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lite_solo_load_player_);
        ...
        databaseReference = database.getReference("LiteSolo_join_player").child("EntryComplete_player");

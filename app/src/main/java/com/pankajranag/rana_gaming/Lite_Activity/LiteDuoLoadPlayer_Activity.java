...
public class LiteDuoLoadPlayer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lite_duo_load_player_);
        ...
        databaseReference = database.getReference("LiteDuo_join_player").child("EntryComplete_player");

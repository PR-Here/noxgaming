...
public class Lite_Tdm_Mode extends AppCompatActivity implements RewardedVideoAdListener {
    ...
    private DatabaseReference dbrefrence = databaseReference.child("pubglite").child("image3");
    ImageView bigimage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseRemoteConfig.fetch().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Lite_Tdm_Mode.this, "Something went wrong please try again",
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(Lite_Tdm_Mode.this)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                TextView  pubg_id;
                                EditText pubg_name;
                                final Dialog dialog1 = new Dialog(Lite_Tdm_Mode.this);
    ...
    private void init() {
        ...
        info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageView cut;
                final Dialog dialog = new Dialog(Lite_Tdm_Mode.this);
        ...
        Post = FirebaseDatabase.getInstance().getReference().child("tdmlite");
    }
...
//                                        rank10.setText(drank10);
                                    ...
                                    @Override
                                    public void onCancelled(@NonNull DatabaseError databaseError) {
                                        Toast.makeText(Lite_Tdm_Mode.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();

...
public class LiteTdmLoadPlayer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lite_tdm_load_player_);
        ...
        databaseReference = database.getReference("LiteTDM_join_player").child("EntryComplete_player");

...
public class TdmLoadPlayer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tdm_load_player_);
        ...
        databaseReference = database.getReference("TDM_join_player").child("EntryComplete_player");

...
public class LoadPlayer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_load_player_);
        ...
        databaseReference = database.getReference("ClassicSolo_join_player").child("EntryComplete_player");

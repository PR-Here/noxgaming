...
public class ArcadeLoadPlayer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arcade_load_player_);
        ...
        databaseReference = database.getReference("Arcade_join_player").child("EntryComplete_player");

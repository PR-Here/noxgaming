...
public class DuoLoadPlayer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duo_load_player_);
        ...
        databaseReference = database.getReference("ClassicDuo_join_player").child("EntryComplete_player");

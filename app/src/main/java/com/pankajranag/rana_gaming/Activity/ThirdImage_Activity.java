...
public class ThirdImage_Activity extends AppCompatActivity implements RewardedVideoAdListener {
    ...
    private DatabaseReference dbrefrence = databaseReference.child("mainactivity").child("image3");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_image_);
                ...
                handler2.postDelayed(
                        new Runnable() {
                            public void run() {
                                ...
                                new AlertDialog.Builder(ThirdImage_Activity.this)
                                        ...
                                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                TextView  pubg_id;
                                                EditText pubg_name;
                                                final Dialog dialog1 = new Dialog(ThirdImage_Activity.this);
        ...
        info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(ThirdImage_Activity.this);
        ...
        mFirebaseRemoteConfig.fetch().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(ThirdImage_Activity.this, "Something went wrong please try again",
    ...
    private void init() {
        ...
        Post = FirebaseDatabase.getInstance().getReference().child("payloadmode");
    }
    ...
    protected void onStart() {
        ...
        dbrefrence.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(ThirdImage_Activity.this)
                        .load(firstimage)
                        .into(bigimage);

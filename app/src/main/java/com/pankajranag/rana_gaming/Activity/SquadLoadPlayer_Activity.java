...
public class SquadLoadPlayer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squad_load_player_);
        ...
        databaseReference = database.getReference("Classic_join_player").child("EntryComplete_player");

...
public class DuoFreeFireLoad_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duo_free_fire_load_);
        ...
        databaseReference = database.getReference("FreeFireDuo_join_player").child("EntryComplete_player");

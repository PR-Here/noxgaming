...
public class TDMFreeFireLoad_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tdmfree_fire_load_);
        ...
        databaseReference = database.getReference("FreeFireTDM_join_player").child("EntryComplete_player");

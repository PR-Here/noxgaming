...
public class SquadFreeFireLoad_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squad_free_fire_load_);
        ...
        databaseReference = database.getReference("FreeFireSquad_join_player").child("EntryComplete_player");

 ...
 */
public class SoloFreeFire_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_solo_free_fire_, container, false);
